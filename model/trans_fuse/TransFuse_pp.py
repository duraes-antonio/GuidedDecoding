...
class TransFuse_S_PlusPlus(nn.Module):
    def __init__(self, num_classes=1, drop_rate=0.2, normal_init=True, pretrained=False):
        ...
        self.up_c_2_2 = Up(in_ch1=128, out_ch=64, in_ch2=64, attn=True)
    ...
    def forward(self, imgs, labels=None):
        ...
        # BiFusion_block((256, 12, 16), (384, 12, 16)) -> (256, 12, 16)
        x_c = self.up_c(x_u, x_b)

        # BiFusion_block((128, 24, 32), (128, 24, 32)) -> (128, 24, 32)
        x_c_1_1 = self.up_c_1_1(x_u_1, x_b_1)

        # Up((256, 12, 16), (128, 24, 32)) -> (128, 24, 32)
        x_c_1 = self.up_c_1_2(x_c, x_c_1_1)

        # BiFusion_block((64, 48, 64), (64, 48, 64)) -> (64, 48, 64)
        x_c_2_1 = self.up_c_2_1(x_u_2, x_b_2)

        # Up((128, 24, 32), (64, 48, 64)) -> (128, 48, 64)
